...
export abstract class AxiosTransport {
   ...
   * @description: 请求之前处理
   */
  transfromRequest?: (config: AxiosRequestConfig, options: RequestOptions) => AxiosRequestConfig
  /**
   * @description: 请求完成处理
   */
   ...
   */
  requestInterceptor?: (config: AxiosRequestConfig, options: AxiosRequestOptions) => AxiosRequestConfig
  /**
